...
const defaultData = {
  ...
  credentials: {
    admin: {
      ...
      user: { id: 'admin-1', role: 'ADMIN', first_name: 'ادمین', last_name: 'سیستم', email: 'admin@basu.ac.ir' },
    },
    users: [
      {
        email: 'user1@basu.ac.ir',
        password: 'userpass1',
        token: 'demo-user1-token',
        user: { id: 'user-1', role: 'USER', first_name: 'رضا', last_name: 'رضایی', email: 'user1@basu.ac.ir' },
      },
      {
        email: 'user2@basu.ac.ir',
        password: 'userpass2',
        token: 'demo-user2-token',
        user: { id: 'user-2', role: 'USER', first_name: 'سارا', last_name: 'محمدی', email: 'user2@basu.ac.ir' },
      },
    ],
  },
};
